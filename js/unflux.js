$(function() {
  ...
  $('.article-wrapper .article-title .inside .at-illust').after('<div class="img-mask" style="top: 60%;width: 100%;height: 100%;position: absolute;left: 0px;background-color: white;z-index: -1;pointer-events: none;"></div>');
...
function resizeWindow() {
  if (window.innerWidth > 1024) {
      ...
      $('.mn-menu-item-933090').prependTo('.site-banner .mn-menu-lvl1');
      ...
      $('.mn-menu-item-933090').prependTo('.site-banner');
